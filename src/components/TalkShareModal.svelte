...
{#if show}
  ...
  >
    <div
      class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] sm:w-[420px] max-h-[85vh] bg-[#faf8f5] border-[10px] border-[#0284c7] rounded-sm shadow-[8px_8px_0px_0px_#0284c7] overflow-y-auto"
